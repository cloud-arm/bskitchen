...
<body class="hold-transition skin-blue skin-orange sidebar-mini">
    ...
    $result = $db->prepare("SELECT * FROM purchases_list WHERE user_id=$u AND action!='active' AND type='GRN' ");
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="input-group date">
                                                ...
                                                <input type="number" class="form-control" name="dic" step=".01" tabindex="2">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="input-group date">
                                                ...
                                                <input type="number" id="sell1" class="form-control" step=".01" name="sell" tabindex="2">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="input-group date">
                                                ...
                                                <input type="number" id="cost1" class="form-control" step=".01" name="cost" tabindex="2">
                                            </div>
                                        </div>
                                    </div>
